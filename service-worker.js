const CACHE_NAME = 'maybike-v16-1-pdv-cache-v3';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
  './app.js?v=1612',
  './pwa.js?v=1612',
  './hotfix-v155.js?v=1612',
  './hotfix-modulos-v155.js?v=1612',
  './v156-estavel.js?v=1612',
  './v156-movimentacoes-caixa.js?v=1612',
  './v156-resumo-caixa.js?v=1612',
  './v160-venda.js?v=1612',
  './v161-recibo.js?v=1612',
  './v161-os-separadas.js?v=1612',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
