const CACHE_NAME = 'maybike-v16-pdv-cache-v1';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
  './app.js?v=1600',
  './pwa.js?v=1600',
  './hotfix-v155.js?v=1600',
  './hotfix-modulos-v155.js?v=1600',
  './v156-estavel.js?v=1600',
  './v156-movimentacoes-caixa.js?v=1600',
  './v156-resumo-caixa.js?v=1600',
  './v160-venda.js?v=1600',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
