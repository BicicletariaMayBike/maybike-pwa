const CACHE_NAME = 'maybike-v16-1-pdv-cache-v4';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
  './app.js?v=1613',
  './pwa.js?v=1613',
  './hotfix-v155.js?v=1613',
  './hotfix-modulos-v155.js?v=1613',
  './v156-estavel.js?v=1613',
  './v156-movimentacoes-caixa.js?v=1613',
  './v156-resumo-caixa.js?v=1613',
  './v160-venda.js?v=1613',
  './v161-recibo.js?v=1613',
  './v161-os-separadas.js?v=1613',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
