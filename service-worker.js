const CACHE_NAME = 'maybike-v17-pdv-cache-v1';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
  './app.js?v=1700',
  './pwa.js?v=1700',
  './hotfix-v155.js?v=1700',
  './hotfix-modulos-v155.js?v=1700',
  './v156-estavel.js?v=1700',
  './v156-movimentacoes-caixa.js?v=1700',
  './v160-venda.js?v=1700',
  './v161-recibo.js?v=1700',
  './v161-os-separadas.js?v=1700',
  './v170-gestao.js?v=1700',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
