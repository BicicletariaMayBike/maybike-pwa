const CACHE_NAME = 'maybike-v15-6-pdv-cache-v2';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
  './app.js?v=1570',
  './pwa.js?v=1570',
  './cliente-sem-cadastro.js?v=1570',
  './hotfix-v155.js?v=1570',
  './hotfix-modulos-v155.js?v=1570',
  './v156-estavel.js?v=1570',
  './v156-movimentacoes-caixa.js?v=1570',
  './v156-resumo-caixa.js?v=1570',
  './v156-busca-cliente-venda.js?v=1570',
  './manifest.json',
  './icons/icon-192.png',
  './icons/icon-512.png',
